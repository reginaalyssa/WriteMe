"""
Django settings for writeme project.
...
SECRET_KEY = 'c_+#brb-t^r&jcqn31^j2j89^5e07%(#l=qo6mh3t@kj*u&bto'
...
WSGI_APPLICATION = 'writeme.wsgi.application'
